...
describe("anthropicRequestToChatCompletions — LiteLLM parity fixes", () => {
...
describe("chatCompletionsResponseToAnthropic — LiteLLM parity fixes", () => {
...
describe("chatCompletionsStreamToMessagesStream — LiteLLM parity fixes", () => {
